function move(id, position, color) {
    ...
    tl.to("#bgBubble", {duration: 0.15, bottom: "-30px", ease: "ease-out"}, 0)
      .to("#bubble1", {duration: 0.5, y: "160%", boxShadow: 'none', ease: "ease-out",}, 0)
      .to("#bubble2", {duration: 0.5, y: "160%", boxShadow: 'none', ease: "ease-out",}, 0)
      .to("#bubble3", {duration: 0.5, y: "160%", boxShadow: 'none', ease: "ease-out",}, 0)
      .to("#bubble4", {duration: 0.5, y: "160%", boxShadow: 'none', ease: "ease-out",}, 0)
